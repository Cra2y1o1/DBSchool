...
namespace DBSchool {
    ...
    public partial class DBSchoolDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PersonRow AddPersonRow(int Id, string Username, string Password, int level) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public int level {
                get {
                    return ((int)(this[this.tablePerson.levelColumn]));
                }
                set {
                    this[this.tablePerson.levelColumn] = value;
                }
            }
        }
...
namespace DBSchool.DBSchoolDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([Id] = @Original_Id) AND ([Username] = @Origin" +
                "al_Username) AND ([Password] = @Original_Password) AND ([level] = @Original_leve" +
                "l))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Id], [Username], [Password], [level]) VALUES (@Id, @" +
                "Username, @Password, @level);\r\nSELECT Id, Username, Password, level FROM Person " +
                "WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [Id] = @Id, [Username] = @Username, [Password] = @Password, [level] = @level WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([level] = @Original_level));
SELECT Id, Username, Password, level FROM Person WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBSchool.Properties.Settings.Default.DBSchoolConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, [level] FROM dbo.Person";
        ...
        public virtual int Fill(DBSchoolDataSet.PersonDataTable dataTable) {
        ...
        public virtual DBSchoolDataSet.PersonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBSchoolDataSet.PersonDataTable dataTable = new DBSchoolDataSet.PersonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBSchoolDataSet.PersonDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Password, int Original_level) {
        ...
        public virtual int Insert(int Id, string Username, string Password, int level) {
        ...
        public virtual int Update(int Id, string Username, string Password, int level, int Original_Id, string Original_Username, string Original_Password, int Original_level) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, int level, int Original_Id, string Original_Username, string Original_Password, int Original_level) {
            return this.Update(Original_Id, Username, Password, level, Original_Id, Original_Username, Original_Password, Original_level);
        }
    }
