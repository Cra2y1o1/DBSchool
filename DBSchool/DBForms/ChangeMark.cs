    ...
    public partial class ChangeMark : Form
    {
        ...
        private void sumbit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var wordDocument = wordApp.Documents.Open(p + "//documents//ChangeMarkTemplate.dotx");
                ...
                ReplaceWordStub("{idMark}", IdMark.Text, wordDocument);
                ReplaceWordStub("{newMark}", newMark.Text, wordDocument);
